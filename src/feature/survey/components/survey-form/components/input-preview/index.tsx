...
export const InputPreview = memo(
  ({ question, disabled, answer, sessionStart }: Props) => {
        ...
        case "text":
          if (question.mask) {
            return (
              <MaskedInput
                ...
                value={answer}
                onFocus={() => {
                  StoreSessionMetrics("input_clicked", sessionStart, {
          ...
          return (
            <TextInput
              ...
              value={answer}
              onFocus={async () => {
                StoreSessionMetrics("onFocus", sessionStart, {
                  questionId: question.id,
                });
              }}
            />
